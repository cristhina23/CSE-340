...
(
	...
	inv_make character varying NOT NUL,
	inv_model character varying NOT NUL,
	inv_year character(4) NOT NUL,
	inv_description text NOT NUL,
	inv_image character varying NOT NUL,
	inv_thumbnail character varying NOT NUL,
	inv_price numeric(9, 0)  NOT NUL,
	inv_miles integer  NOT NUL,
	inv_color character varying NOT NUL,
...
ALTER TABLE IF EXISTS public.inventory 
    ADD CONSTRAINT fk_classification FOREIGN KEY(classification_id) REFERENCES public.classification(classification_id) MATCH SIMPLE 
    ON UPDATE CASCADE 
    ON DELETE NO ACTION;
